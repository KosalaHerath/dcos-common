...
public class MesosConstants {
    ...
    public static final String MARATHON_BASIC_AUTHENTICATION_MODE = "Basic";
    public static final String MARATHON_TOKEN_AUTHENTICATION_MODE = "Token";
    ...
    public static final String MESOS_IAM_ENDPOINT = "MESOS_IAM_ENDPOINT";
